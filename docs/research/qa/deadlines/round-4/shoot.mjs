/* Deadlines round-4 critic captures. ORIGIN=http://localhost:4380 BASEPATH= node shoot.mjs [names] */
...
const pages = [
  ['gb-cambridge', '/universities/gb-cambridge/'], ['gb-oxford', '/universities/gb-oxford/'], ['ch-eth', '/universities/ch-eth/'],
  ['is-lhi', '/universities/is-lhi/'], ['nl-um-dsai', '/programmes/nl-maastricht-data-science-and-artificial-intelligence-2027-autumn/'],
  ['ie-tcd', '/universities/ie-tcd/'], ['timeline', '/timeline/'],
];
